#include "ANISOTROPIC_SQRT.h"
#include <iostream>

using namespace std;

ANISOTROPIC_SQRT::ANISOTROPIC_SQRT(const Real lambda, const Real mu) :
  _lambda(lambda), _mu(mu)
{
  _name = string("ANISOTROPIC_SQRT");
  //cout << " ANISOTROPIC_SQRT settings are mu = " << mu << endl;
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_SQRT::PK1(const MATRIX2& F)
{
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_SQRT::setAnisotropyDirection(const VEC2& a)
{
  _a = a;
  _a *= 1.0 / _a.norm();
  _A = _a * _a.transpose();
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_SQRT::PK2(const MATRIX2& F)
{
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_SQRT::DPDF(const MATRIX& F)
{
  Real IV = _a.transpose() * (F.transpose() * F) * _a;
  Real sqrtIV = sqrt(IV);
  MATRIX H(4,4);
...
// derivative of PK1 w.r.t. F
///////////////////////////////////////////////////////////////////////
MATRIX2 ANISOTROPIC_SQRT::DPDFFast(const MATRIX2& F, int index)
{
...
///////////////////////////////////////////////////////////////////////
VECTOR ANISOTROPIC_SQRT::flatten(const MATRIX& A)
{
...
///////////////////////////////////////////////////////////////////////
Real ANISOTROPIC_SQRT::psi(const MATRIX2& F)
{
  Real IV = _a.transpose() * (F.transpose() * F) * _a;
  Real sqrtIV = sqrt(IV);
...
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_SQRT::svd(const MATRIX2& F, MATRIX2& U, VECTOR& S, MATRIX2& V) const
{
...
///////////////////////////////////////////////////////////////////////
bool ANISOTROPIC_SQRT::symSchur2(const MATRIX2& A, Real& c, Real& s) const
{
...
// take the svd of F, so we can form the polar decomposition
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_SQRT::mySVD(const MATRIX2& F, MATRIX2& U, VECTOR& S, MATRIX2& V) const
{
  // form A^T * A
...
// take the polar decomposition, using SVD
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_SQRT::polarDecomposition(const MATRIX2& F, MATRIX2& R, MATRIX2& S) const
{
  MATRIX2 U;
  VECTOR s;
  MATRIX2 V;
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_SQRT::DSDF(const MATRIX2& F, const MATRIX2& R, const MATRIX2& S, const MATRIX2& DR, int index)
{
  MATRIX2 eiej;
  eiej.setZero();
  const int i = index % 2;
...
///////////////////////////////////////////////////////////////////////
MATRIX3 ANISOTROPIC_SQRT::promote(const MATRIX2& A)
{
  MATRIX3 final;
  final.setZero();
  final(2,2) = 1;
...
///////////////////////////////////////////////////////////////////////
MATRIX2 ANISOTROPIC_SQRT::demote(const MATRIX3& A)
{
  MATRIX2 final;
  for (int y = 0; y < 2; y++)
    for (int x = 0; x < 2; x++)
...
///////////////////////////////////////////////////////////////////////
VECTOR ANISOTROPIC_SQRT::skew(const MATRIX3& A)
{
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_SQRT::DRDF(const MATRIX2& F, const MATRIX2& R, const MATRIX2& S, int index)
{
  MATRIX3 R3,S3;
  R3 = promote(R);
  S3 = promote(S);
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
bool ANISOTROPIC_SQRT::testSVD()
{
  MATRIX2 F;
  F << 0.710625, 0.00236432,
      0.0687256,    1.00035;

  ANISOTROPIC_SQRT length;
