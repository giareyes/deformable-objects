...
ANISOTROPIC_ARAP::ANISOTROPIC_ARAP(const Real lambda, const Real mu) :
  _lambda(lambda), _mu(mu)
{
  _name = string("ANISOTROPIC_ARAP");
  //cout << " ANISOTROPIC_ARAP settings are mu = " << mu << endl;
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_ARAP::PK1(const MATRIX2& F)
{
  Real IV = _a.transpose() * (F.transpose() * F) * _a;

#if USING_SIGNED_VERSION
  MATRIX2 R, S;
  polarDecomposition(F,R,S);
  Real I4 = _a.transpose() * S * _a;
  Real sign = (I4 > 0.0) ? 1.0 : -1.0;
  MATRIX2 P = (1.0 - sign / sqrt(IV)) * F * _A;
#else
  MATRIX2 P = (1.0 - 1.0 / sqrt(IV)) * F * _A;
#endif
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_ARAP::setAnisotropyDirection(const VEC2& a)
{
  _a = a;
  _a *= 1.0 / _a.norm();
  _A = _a * _a.transpose();
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_ARAP::PK2(const MATRIX2& F)
{
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_ARAP::DPDF(const MATRIX& F)
{
  Real IV = _a.transpose() * (F.transpose() * F) * _a;
  Real sqrtIV = sqrt(IV);
  MATRIX H(4,4);
  ...
  Real I4 = _a.transpose() * S * _a;
  Real sign = (I4 > 0.0) ? 1.0 : -1.0;
  H = (1.0 - sign / sqrtIV) * blockA + (sign / (sqrtIV * sqrtIV * sqrtIV)) * (g * g.transpose());
#else
  H = (1.0 - 1.0 / sqrtIV) * blockA + (1.0 / (sqrtIV * sqrtIV * sqrtIV)) * (g * g.transpose());
#endif
  H = _mu * H;
...
// derivative of PK1 w.r.t. F
///////////////////////////////////////////////////////////////////////
MATRIX2 ANISOTROPIC_ARAP::DPDFFast(const MATRIX2& F, int index)
{
...
///////////////////////////////////////////////////////////////////////
VECTOR ANISOTROPIC_ARAP::flatten(const MATRIX& A)
{
...
///////////////////////////////////////////////////////////////////////
Real ANISOTROPIC_ARAP::psi(const MATRIX2& F)
{
  Real IV = _a.transpose() * (F.transpose() * F) * _a;
  Real sqrtIV = sqrt(IV);
  ...
  Real I4 = _a.transpose() * S * _a;
  Real sign = (I4 > 0.0) ? 1.0 : -1.0;
  return _mu * 0.5 * (sign * sqrtIV - 1.0) * (sign * sqrtIV - 1.0);
#else
  return _mu * 0.5 * (sqrtIV - 1.0) * (sqrtIV - 1.0);
#endif
}
...
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_ARAP::svd(const MATRIX2& F, MATRIX2& U, VECTOR& S, MATRIX2& V) const
{
...
///////////////////////////////////////////////////////////////////////
bool ANISOTROPIC_ARAP::symSchur2(const MATRIX2& A, Real& c, Real& s) const
{
...
// take the svd of F, so we can form the polar decomposition
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_ARAP::mySVD(const MATRIX2& F, MATRIX2& U, VECTOR& S, MATRIX2& V) const
{
  // form A^T * A
...
// take the polar decomposition, using SVD
///////////////////////////////////////////////////////////////////////
void ANISOTROPIC_ARAP::polarDecomposition(const MATRIX2& F, MATRIX2& R, MATRIX2& S) const
{
  MATRIX2 U;
  VECTOR s;
  MATRIX2 V;
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_ARAP::DSDF(const MATRIX2& F, const MATRIX2& R, const MATRIX2& S, const MATRIX2& DR, int index)
{
  MATRIX2 eiej;
  eiej.setZero();
  const int i = index % 2;
...
///////////////////////////////////////////////////////////////////////
MATRIX3 ANISOTROPIC_ARAP::promote(const MATRIX2& A)
{
  MATRIX3 final;
  final.setZero();
  final(2,2) = 1;
...
///////////////////////////////////////////////////////////////////////
MATRIX2 ANISOTROPIC_ARAP::demote(const MATRIX3& A)
{
  MATRIX2 final;
  for (int y = 0; y < 2; y++)
    for (int x = 0; x < 2; x++)
...
///////////////////////////////////////////////////////////////////////
VECTOR ANISOTROPIC_ARAP::skew(const MATRIX3& A)
{
...
///////////////////////////////////////////////////////////////////////
MATRIX ANISOTROPIC_ARAP::DRDF(const MATRIX2& F, const MATRIX2& R, const MATRIX2& S, int index)
{
  MATRIX3 R3,S3;
  R3 = promote(R);
  S3 = promote(S);
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
bool ANISOTROPIC_ARAP::testSVD()
{
  MATRIX2 F;
  F << 0.710625, 0.00236432,
      0.0687256,    1.00035;

  ANISOTROPIC_ARAP length;
